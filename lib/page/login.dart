  ...
  void initState() {
    ...
    for (var i = 0; i < 20; i++) {
      BobbleBean particle = new BobbleBean()
        //获取随机透明度的白色颜色
        ..color = getRandonWhightColor(_random)
        //指定一个位置 每次绘制时还会修改
        ..postion = Offset(-1, -1)
        //气泡运动速度
    ...
    _fadeAnimationController = new AnimationController(vsync: this, duration: Duration(milliseconds: 500));
